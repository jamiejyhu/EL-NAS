...
class Network(nn.Module):
    ...
    def __init__(self, C, num_classes, datachannel, layers, criterion, steps=8, multiplier=4, stem_multiplier=3):
        ...
        self.stem = nn.Sequential(
            # indian:200, pavia:103 176 salinas:204 houston:144
            nn.Conv2d(datachannel, C_curr, 3, padding=1, bias=False),
